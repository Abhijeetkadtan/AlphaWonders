...
CATCH_0079:
	{
		...
		NullCheck(L_18);
		String_t* L_22;
		L_22 = VirtualFuncInvoker3< String_t*, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(35, L_18, L_19, L_20, L_21);
		V_1 = L_22;
...
IL_0090:
	{
		int32_t L_23 = __this->____position;
		int32_t L_24 = V_0;
		__this->____position = ((int32_t)il2cpp_codegen_add(L_23, L_24));
		String_t* L_25 = V_1;
		String_t* L_26;

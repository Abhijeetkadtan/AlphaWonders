...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_m3C2F268AE2EF720842A45C9F1CB9567A567E10E6(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 58));
...
{
	{
		...
		L_0 = Dictionary_2_get_Values_m81E8029AF7DF562248819E898DF15C96AC2FEE12(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 59));
		return (RuntimeObject*)L_0;
	}
}
